...
\begin{frame}{WER/CER Results (Parakeet, VPB Small Dataset)}
    ...
    \begin{itemize}
        \item Note: Parakeet shows slightly better and more stable WER/CER than Fast-Conformer across all sets (~10 hours).
    \end{itemize}
\end{frame}
...
\begin{frame}{Contact}
    \begin{itemize}
        ...
        \item \textbf{Le Hong Ky}: Senior Data Scientist, AI Center
